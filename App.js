...
////////////////////// API KEY at https://developer.foursquare.com/
...
export default class App extends React.Component {
  ...
  searchBike = (address) => {
    ...
    axios
      ...
      .get(
        ...
        address +
        '&query=bikerental&client_id= ' //////put foursquare APIKEY after =
      )
      .then(res => {
  ...
  searchSpots = (address1) => {
    ...
    axios
      .get(
        'https://api.foursquare.com/v2/venues/explore?near=' + address1 + '&client_id= ' /////////////put foursquare APIKEY after =
      )
      .then(res => {
