...
export default class Recommended extends React.Component {
    ...
    componentDidMount = () => { //recommended spots on page load
        axios
            .get(
                'https://api.foursquare.com/v2/venues/explore?near=' + this.state.near + '&client_id= ' ////// put foursquare APIKEY after =
            )
            .then(res => {
                    ...
                    {this.state.spots1.map((shop, index) => (
                        ...
                        <Text style={{ fontWeight: "bold", fontSize: 15 }} key={index}
                            ...
                            <Image
                                ...
                                style={{
                                    flex: 1, justifyContent: "center", height: 85, width: 85, alignItems: "center"
                                }}
                            />
